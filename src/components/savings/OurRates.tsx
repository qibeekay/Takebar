...
const items = [
  ...
  },
  {
    ...
    desc: "Investment profits are distributed back to members as higher interest rates",
    img: "c1.png",
  },
  {
    title: "Regular Compounding",
    desc: "Interest compounds monthly, helping your savings grow faster over time",
    img: "calendar.png",
  },
];
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 pb-[7rem]">
      <div className="flex flex-col items-center justify-center">
        ...
        {/* header */}
        <h1 className="header">How Our Rates Work</h1>
        <p className="text">
          Our cooperative model allows us to offer higher returns by pooling
          resources and sharing the benefits among all members
        </p>
      </div>
